namespace cubee {
    ...
    export class ComboBox<T> extends AComponent {

        private _selectedIndex = new NumberProperty(-1, false, false);
        private _selectedItem = new Property<T>(null, true, false);
        private items: T[] = [];
        ...
        constructor() {
            ...
            this.element.addEventListener("change", () => {
                let val = (<HTMLSelectElement>this.element).value;
                if (val == null || val == "") {
                    this._selectedIndex.value = -1;
                    this._selectedItem.value = null;
                } else {
                    this._selectedIndex.value = parseInt(val);
                }
            });
            
            this._selectedIndex.addChangeListener(() => {
                
            });
            
            this._selectedItem.addChangeListener(() => {
                let item = this._selectedItem.value;
                if (item == null) {
                    this._selectedIndex.value = -1;
                    (<HTMLSelectElement>this.element).value = null;
                } else {
                    let index = -1;
                    ...
                    if (index < 0) {
                        ...
                        (<HTMLSelectElement>this.element).value = "" + index;
                    }
                }
            });
        }
        ...
        protected selectedIndexProperty() {
        ...
        protected selectedItemProperty() {
